...
students1 = ai("Ankit", 19, "Bihar")
students2 = ai("Aditya", 20, "Patna")
students3 = ai("Shubham", 24, "Haryana")
students4 = ai("Arun", 26, "UP")

print(f"NAME: {students1.name}, AGE: {students1.age}, ADDRESS: {students1.address}")
print(f"NAME: {students2.name}, AGE: {students2.age}, ADDRESS: {students2.address}")
print(f"NAME: {students3.name}, AGE: {students3.age}, ADDRESS: {students3.address}")
print(f"NAME: {students4.name}, AGE: {students4.age}, ADDRESS: {students4.address}")
